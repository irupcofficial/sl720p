...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
    ...
    <script> 
    $(function(){
    $("#mainheader").load("share/mainheader.php"); 
    $("#respheader").load("share/respheader.php");
    $("#letter").load("share/letter.php");
    $("#nav").load("share/nav.php");
    $("#footer").load("share/mainfooter.php"); 
    });
    </script> 
</head>
